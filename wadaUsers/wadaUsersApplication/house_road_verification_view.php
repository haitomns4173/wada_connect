...
<body>
  ...
  <div id="app">
    ...
    <div id="main">
      ...
      <?php
      require_once '../../php/house_road_verification/view_house_road_verification.php';
      ?>
      <div class="page-heading">
        <div class="page-title">
          <div class="row">
            <div class="col-12 col-md-6 order-md-1 order-last">
              <h3>View House Road Verification Form</h3>
              <p class="text-subtitle text-muted">A page where applicant can view House Road Verification information</p>
            </div>
          </div>
        </div>
        <section class="section">
          <div class="row" id="basic-table">
                      ...
                      <table class="table table-lg">
                        <tbody>
                          <tr>
                            ...
                            <td class="text-bold-500"><?php echo $wadaMemberHouseRoadMapNo ?></td>
                          </tr>
                          <tr>
                            <td class="text-bold-500">Kitta No. :</td>
                            <td class="text-bold-500"><?php echo $wadaMemberHouseRoadKittaNo ?></td>
                          </tr>
                          <tr>
                            <td class="text-bold-500">Area :</td>
                            <td class="text-bold-500"><?php echo $wadaMemberHouseRoadArea ?></td>
                          </tr>
                          <tr>
                            <td class="text-bold-500">Road Presences :</td>
                            <td class="text-bold-500"><?php echo $wadaMemberHouseRoadRoadPresence ?></td>
                          </tr>
                        </tbody>
                      </table>
                    </div>
            ...
            <div class="col-12 col-md-6">
              <div class="card">
                <div class="card-header">
                  <h4 class="card-title">घर खरीददार विवरण</h4>
                </div>
                <div class="card-content">
                  <div class="card-body">
                    <div class="table-responsive">
                      <table class="table table-lg">
                        <tbody>
                          <tr>
                            <td class="text-bold-500">जग्गा खरिदकर्ताको नाम :</td>
                            <td class="text-bold-500"><?php echo $wadaMemberHouseRoadHouseBuyerName ?></td>
                          </tr>
                          <tr>
                            <td class="text-bold-500">जग्गा खरिद गर्ने जिल्ला :</td>
                            <td class="text-bold-500"><?php echo $wadaMemberHouseRoadBuyerDistrict ?></td>
                          </tr>
                          <tr>
                            <td class="text-bold-500">जग्गा खरिद गर्ने नगरपालिका :</td>
                            <td class="text-bold-500"><?php echo $wadaMemberHouseRoadBuyerMunicipality ?></td>
                          </tr>
                          <tr>
                            <td class="text-bold-500">जग्गा खरिद गर्ने वार्ड :</td>
                            <td class="text-bold-500"><?php echo $wadaMemberHouseRoadBuyerWard ?></td>
                          </tr>
                        </tbody>
                      </table>
                    </div>
                  ...
                  <div class="card-body">
                    <div class="row">
                      <div class="col-md-4 col-12">
                        <img src='../../<?php echo $wadaMemberHouseRoadCitizenshipDocument ?>' alt='Citizenship Card' class='img-thumbnail'>
                      </div>
                      <div class="col-md-4 col-12">
                        <img src='../../<?php echo $wadaMemberHouseRoadLandOwnershipDocument ?>' alt='Land Ownership Document' class='img-thumbnail'>
                      </div>
                      <div class="col-md-4 col-12">
                        <img src='../../<?php echo $wadaMemberHouseRoadLandMapDocument ?>' alt='Land Map Document' class='img-thumbnail'>
                      </div>
                      <div class="col-md-4 col-12">
                        <br>
                        <img src='../../<?php echo $wadaMemberHouseRoadLandTaxDocument ?>' alt='Citizenship Card' class='img-thumbnail'>
                      </div>
                    </div>
                  </div>
                </div>
            ...
            <div class="col-12">
              <div class="card">
                ...
                <div class="card-body">
                  <div class="buttons">
                    <a href="../../php/send_to_wada_status.php?wadaApplicationID=<?php echo $wadaConnectApplicationListingID ?>&wadaMemberFormID=<?php echo $wadaMemberHouseRoadFormID ?>&applicationType=4" class="btn icon icon-left btn-success"><i data-feather="send"></i>Send to Wada</a>
                    <a href="../../php/house_road_verification/house_road_verification_print.php?wadaMemberHouseRoadFormID=<?php echo $wadaMemberHouseRoadFormID ?>&wadaMemberID=<?php echo $wadaMemberHouseRoadUserID ?>" class="btn icon icon-left btn-primary" target="_blank"><i data-feather="download"></i>Download Application</a>
