...
<body>
  ...
  <div id="app">
    ...
    <div id="main">
      ...
      <?php
      require_once '../../php/four_boundries_certificate/view_four_boundries_certificate.php';
      ?>
      <div class="page-heading">
        <div class="page-title">
          <div class="row">
            <div class="col-12 col-md-6 order-md-1 order-last">
              <h3>View Four Boundaries Certificate</h3>
              <p class="text-subtitle text-muted">A page where applicant can view Four Boundaries Certificate information</p>
            </div>
          </div>
        </div>
          ...
          <div class="row" id="basic-table">
                      ...
                      <table class="table table-lg">
                        <tbody>
                          <tr>
                            ...
                            <td class="text-bold-500"><?php echo ucfirst($wadaMemberFourBoundariesDistrict) ?></td>
                          </tr>
                          <tr>
                            <td class="text-bold-500">Municipality :</td>
                            <td class="text-bold-500"><?php echo ucfirst($wadaMemberFourBoundariesMunicipality) ?></td>
                          </tr>
                          <tr>
                            <td class="text-bold-500">Kitta No. :</td>
                            <td class="text-bold-500"><?php echo $wadaMemberFourBoundariesKittaNo ?></td>
                          </tr>
                          <tr>
                            <td class="text-bold-500">Area :</td>
                            <td class="text-bold-500"><?php echo $wadaMemberFourBoundariesArea ?></td>
                          </tr>
                        </tbody>
                      </table>
                    </div>
                  ...
                  <div class="card-body">
                    <div class="table-responsive">
                      <table class="table table-lg">
                        <tbody>
                          <tr>
                            <td class="text-bold-500">पूर्व जग्गा मालिकको विवरण :</td>
                            <td class="text-bold-500"><?php echo $wadaMemberFourBoundariesEastPersonName ?></td>
                            <td class="text-bold-500"><?php echo $wadaMemberFourBoundariesEast ?></td>
                          </tr>
                          <tr>
                            <td class="text-bold-500">पश्चिम जग्गा मालिकको विवरण :</td>
                            <td class="text-bold-500"><?php echo $wadaMemberFourBoundariesWestPersonName ?></td>
                            <td class="text-bold-500"><?php echo $wadaMemberFourBoundariesWest ?></td>
                          </tr>
                          <tr>
                            <td class="text-bold-500">उत्तर जग्गा मालिकको विवरण :</td>
                            <td class="text-bold-500"><?php echo $wadaMemberFourBoundariesNorthPersonName ?></td>
                            <td class="text-bold-500"><?php echo $wadaMemberFourBoundariesNorth ?></td>
                          </tr>
                          <tr>
                            <td class="text-bold-500">दक्षिण जग्गा मालिकको विवरण :</td>
                            <td class="text-bold-500"><?php echo $wadaMemberFourBoundariesSouthPersonName ?></td>
                            <td class="text-bold-500"><?php echo $wadaMemberFourBoundariesSouth ?></td>
                          </tr>
                        </tbody>
                      </table>
                    </div>
                  ...
                  <div class="card-body">
                    <div class="row">
                      <div class="col-md-4 col-12">
                        <img src='../../<?php echo $wadaMemberFourBoundariesCitizenshipDocument ?>' alt='Citizenship Card' class='img-thumbnail'>
                      </div>
                      <div class="col-md-4 col-12">
                        <img src='../../<?php echo $wadaMemberFourBoundariesLandOwnershipDocument ?>' alt='Land Ownership Document' class='img-thumbnail'>
                      </div>
                      <div class="col-md-4 col-12">
                        <img src='../../<?php echo $wadaMemberFourBoundariesLandMapDocument ?>' alt='Land Map Document' class='img-thumbnail'>
                      </div>
                      <div class="col-md-4 col-12">
                        <br>
                        <img src='../../<?php echo $wadaMemberFourBoundariesLandTaxDocument ?>' alt='Citizenship Card' class='img-thumbnail'>
                      </div>
                    </div>
                  </div>
                </div>
            ...
            <div class="col-12">
              <div class="card">
                ...
                <div class="card-body">
                  <div class="buttons">
                    <a href="../../php/send_to_wada_status.php?wadaApplicationID=<?php echo $wadaConnectApplicationListingID ?>&wadaMemberFormID=<?php echo $wadaMemberFourBoundariesFormID ?>&applicationType=1" class="btn icon icon-left btn-success"><i data-feather="send"></i>Send to Wada</a>
                    <a href="../../php/four_boundries_certificate/four_boundries_certificate_print.php?wadaMemberFourBoundariesFormID=<?php echo $wadaMemberFourBoundariesFormID ?>&wadaMemberID=<?php echo $wadaMemberFourBoundariesUserID ?>" class="btn icon icon-left btn-primary" target="_blank"><i data-feather="download"></i>Download Application</a>
