...
<body>
  ...
  <div id="app">
    ...
    <div id="main">
      ...
      <?php
      require_once '../../php/relation_certificate_verification/view_relation_certificate_verification.php';
      ?>
      <div class="page-heading">
        <div class="page-title">
          <div class="row">
            <div class="col-12 col-md-6 order-md-1 order-last">
              <h3>View Relation Verification Form</h3>
              <p class="text-subtitle text-muted">A page where applicant can view Relation Verification information</p>
            </div>
          </div>
        </div>
          ...
          <div class="row" id="basic-table">
                  ...
                  <div class="card-body">
                    <div class="table-responsive">
                      <table class="table table-lg">
                        <tbody>
                          <tr>
                            <td class="text-bold-500">पूरा नाम :</td>
                            <td class="text-bold-500"><?php echo $wadaMemberRelationFullName ?></td>
                          </tr>
                          <tr>
                            <td class="text-bold-500">उमेर :</td>
                            <td class="text-bold-500"><?php echo $wadaMemberRelationAge ?></td>
                          </tr>
                          <tr>
                            <td class="text-bold-500">लिङ्ग :</td>
                            <td class="text-bold-500"><?php echo $wadaMemberRelationGender ?></td>
                          </tr>
                          <tr>
                            <td class="text-bold-500">हालको सम्बन्ध :</td>
                            <td class="text-bold-500"><?php echo $wadaMemberRelationRelation ?></td>
                          </tr>
                        </tbody>
                      </table>
                    </div>
                      ...
                      <table class="table table-lg">
                        <tbody>
                          <tr>
                            ...
                            <td class="text-bold-500"><?php echo ucfirst($wadaMemberRelationDistrict) ?></td>
                          </tr>
                          <tr>
                            <td class="text-bold-500">Municipality :</td>
                            <td class="text-bold-500"><?php echo ucfirst($wadaMemberRelationMunicipality) ?></td>
                          </tr>
                          <tr>
                            <td class="text-bold-500">Municipality Type :</td>
                            <td class="text-bold-500"><?php echo $wadaMemberRelationMunicipalityType ?></td>
                          </tr>
                          <tr>
                            <td class="text-bold-500">Ward :</td>
                            <td class="text-bold-500"><?php echo $wadaMemberRelationWard ?></td>
                          </tr>
                        </tbody>
                      </table>
                    </div>
                  ...
                  <div class="card-body">
                    <div class="row">
                      <div class="col-md-4 col-12">
                        <img src='../../<?php echo $wadaMemberRelationCitizenshipDocument ?>' alt='Citizenship Card' class='img-thumbnail'>
                      </div>
                    </div>
                  </div>
                </div>
            ...
            <div class="col-12">
              <div class="card">
                ...
                <div class="card-body">
                  <div class="buttons">
                    <a href="../../php/send_to_wada_status.php?wadaApplicationID=<?php echo $wadaConnectApplicationListingID ?>&wadaMemberFormID=<?php echo $wadaMemberRelationFormID ?>&applicationType=3" class="btn icon icon-left btn-success"><i data-feather="send"></i>Send to Wada</a>
                    <a href="../../php/relation_certificate_verification/relation_certificate_verification_print.php?wadaMemberRelationVerificationFormID=<?php echo $wadaMemberRelationFormID ?>&wadaMemberID=<?php echo $wadaMemberRelationUserID ?>" class="btn icon icon-left btn-primary" target="_blank"><i data-feather="download"></i>Download Application</a>
