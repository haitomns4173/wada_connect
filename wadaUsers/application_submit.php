...
<head>
  ...
  <title>Application Submit - Wada Connect</title>
        ...
        <div class="page-title">
          <div class="row">
            <div class="col-12 col-md-6 order-md-1 order-last">
              ...
              <p class="text-subtitle text-muted">Track and manage submitted applications.</p>
            </div>
          </div>
        </div>
          ...
          <div class="card">
            <div class="card-body">
              <table class="table table-striped" id="table1">
                ...
                <tbody>
                  <?php
                  require_once '../php/select_wada_member_application.php';
                  ?>
                </tbody>
              </table>
            </div>
